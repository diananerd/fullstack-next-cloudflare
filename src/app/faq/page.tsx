                ...
                <div className="space-y-8">
                    ...
                    <div className="bg-white/80 backdrop-blur-sm p-8 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
                        ...
                        <p className="text-gray-600 leading-relaxed">
                            ...
                            force field&quot; to your image. We inject complex
                            mathematical patterns (noise) that are invisible to
                            the human eye but confusing to AI models. When an AI
                            tries to learn your style or manipulate your image,
                            these patterns cause it to fail and produce chaotic
                            results.
                        </p>
                    </div>
                    ...
                    <div className="bg-white/80 backdrop-blur-sm p-8 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
                        ...
                        <p className="text-gray-600 leading-relaxed">
                            To you and your fans, <strong>no</strong>. The
                            changes are imperceptible. Your colors,
                            brushstrokes, and details remain exactly as you
                            created them. The protection only becomes
                            &quot;visible&quot; when an AI model tries to
                            process the file.
                        </p>
                    </div>
                    ...
                    <div className="bg-white/80 backdrop-blur-sm p-8 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
                        ...
                        <p className="text-gray-600 leading-relaxed">
                            ...
                            for anyone attempting to train AI on your work. It
                            turns what is currently an easy, automated theft
                            into a complex technical problem, deterring the vast
                            majority of scrapers.
                        </p>
                    </div>
                    ...
                    <div className="bg-white/80 backdrop-blur-sm p-8 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
                        ...
                        <p className="text-gray-600 leading-relaxed">
                            Our technology is specially designed to disrupt the
                            most common generative AI models used for style
                            mimicry, such as Stable Diffusion, LoRA training,
                            and SDEdit.
                        </p>
                    </div>
                    ...
                    <div className="bg-white/80 backdrop-blur-sm p-8 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
                        ...
                        <p className="text-gray-600 leading-relaxed">
                            Yes! It is effective on digital art, illustrations,
                            paintings, and even photography. We currently
                            support standard high-quality formats like PNG and
                            JPEG up to 50MB per file.
                        </p>
                    </div>
                </div>
