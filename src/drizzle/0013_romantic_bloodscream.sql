...
CREATE TABLE `__new_artworks` (
	...
	`url` text NOT NULL,
	`method` text DEFAULT 'poisoning' NOT NULL,
	`protection_status` text DEFAULT 'idle' NOT NULL,
	`job_id` text,
	`metadata` text,
	`width` integer,
	`height` integer,
...
ALTER TABLE `artwork_jobs` ADD `current_step` text;--> statement-breakpoint
ALTER TABLE `artwork_jobs` ADD `result` text;