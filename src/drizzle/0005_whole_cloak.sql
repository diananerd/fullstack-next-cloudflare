...
CREATE TABLE `__new_artworks` (
	...
	`url` text NOT NULL,
	`protected_url` text,
	`protected_r2_key` text,
	`protection_status` text DEFAULT 'queued' NOT NULL,
	`job_id` text,
	`metadata` text,
	`width` integer,
	`height` integer,
...
INSERT INTO `__new_artworks`("id", "title", "description", "user_id", "r2_key", "url", "protected_url", "protected_r2_key", "protection_status", "job_id", "metadata", "width", "height", "size", "created_at", "updated_at") SELECT "id", "title", "description", "user_id", "r2_key", "url", "protected_url", "protected_r2_key", "protection_status", "job_id", "metadata", "width", "height", "size", "created_at", "updated_at" FROM `artworks`;--> statement-breakpoint
