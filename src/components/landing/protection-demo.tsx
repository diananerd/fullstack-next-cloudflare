...
export function ProtectionDemo({ hasSession }: { hasSession?: boolean }) {
    const [messages, setMessages] = useState<Message[]>([
        {
            ...
            role: "bot",
            type: "text",
            text: "I am a Generative AI Model. Upload an image to generate new variations.",
        },
    ]);
    ...
    useEffect(() => {
        if (status === "typing_prompt") {
            const promptText =
                "Make a variation of this artwork, detailed oil painting style.";
            let i = 0;
            ...
            const complaintText =
                "What is this?? The style is completely broken!";
            let i = 0;
            const interval = setInterval(() => {
            ...
            setTimeout(() => {
                ...
                setTimeout(() => {
                    const botMsg: Message = {
                        ...
                        type: "image-result",
                        imageUrl:
                            "https://images.unsplash.com/photo-1544005313-94ddf0286df2?q=80&w=600&auto=format&fit=crop", // Same image but we will apply CSS filters
                    ...
                    <div className="flex items-center gap-4 p-4 bg-white rounded-xl shadow-sm border border-gray-100">
                        ...
                        <div className="text-left">
                            ...
                            <p className="text-sm text-gray-500">
                                Your art remains beautiful and unchanged.
                            </p>
                        </div>
                    </div>
                    <div className="flex items-center gap-4 p-4 bg-white rounded-xl shadow-sm border border-gray-100">
                        ...
                        <div className="text-left">
                            ...
                            <p className="text-sm text-gray-500">
                                They see chaos and can't create variations.
                            </p>
                        </div>
                    </div>
                </div>
                                        ...
                                        <img
                                            ...
                                            className={cn(
                                                ...
                                                msg.type === "image-result" &&
                                                    "filter contrast-[1.4] brightness-90 hue-rotate-[120deg] saturate-[3] blur-[1px] invert-[.1]", // THE GLITCH
                                            )}
                                        />
                        ...
                        >
                            <input
                                ...
                                className={cn(
                                    ...
                                    status === "awaiting_user_trigger" &&
                                        "group-hover:ring-gray-300 group-hover:bg-gray-100",
                                )}
                            />
                            <div
                                className={cn(
                            ...
                            {showClickHint && (
                                <div className="absolute -top-20 right-2 z-20 pointer-events-none animate-in fade-in duration-500">
                                    <div className="flex flex-col items-center animate-bounce">
                                        <span className="text-red-500 font-bold text-2xl -rotate-12 font-mono whitespace-nowrap">
                                            click here
                                        </span>
